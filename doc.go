...
//
// The package exposes repository-default Session, Stream, SendStream, and
// RecvStream interfaces for opening, accepting, reading, writing, and closing
// multiplexed streams over a single transport connection.
//
